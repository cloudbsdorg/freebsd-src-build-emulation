...
| S5.7 | Write device security tests | NOT STARTED | | | | | S5.1–S5.6 | `tests/usr.sbin/emu/device_security_test.sh` | MMIO bounds, device state corruption, network isolation |
