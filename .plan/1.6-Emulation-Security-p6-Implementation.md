...
| S4.4 | Implement PowerPC big-endian support | NOT STARTED | | | | | S4.1, S4.3 | `usr.sbin/emu/emu_decoder.c`, `usr.sbin/emu/emu_dev_*.c` | Update PowerPC decoder and devices to use big-endian memory accessors. |
