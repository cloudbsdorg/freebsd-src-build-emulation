...
| S4.2 | Implement ELF loader byte-swapping | NOT STARTED | | | | | 5.5 | `usr.sbin/emu/emu_boot.c` | When loading big-endian ELF binaries, swap bytes in ELF header, program headers, and segments. Use `elf_byte_swap` helper. |
