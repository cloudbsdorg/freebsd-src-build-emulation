...
| S0.5 | Implement `kern.emulation.modules_loaded` sysctl | 🔄 IN PROGRESS | freedev002 | | 2026-04-26 07:36 UTC | | S0.1 | `sys/emulation/emu_sysctl.c` | Read-only sysctl listing all loaded emulation modules. |
