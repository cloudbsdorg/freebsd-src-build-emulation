...
| S6.9 | Write Capsicum sandboxing integration tests | NOT STARTED | | | | | S6.8 | `tests/usr.sbin/emu/capsicum_integration_test.sh` | Start instance with sandboxing enabled, verify it runs correctly, verify it cannot open new files or access /proc. |
