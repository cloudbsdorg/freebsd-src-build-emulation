...
| S4.5 | Test cross-endian emulation | NOT STARTED | | | | | S4.1-S4.4 | `tests/usr.sbin/emu/endian_test.sh` | Add tests for loading/running big-endian binaries on little-endian host. Verify memory accessors work correctly. |
