...
| S6.8 | Write Capsicum sandboxing unit tests | NOT STARTED | | | | | S6.1, S6.2 | `tests/sys/emulation/capsicum_test.c` | `test_capsicum_enter()`, `test_capsicum_rights_limit()`, `test_emulator_runs_under_capsicum()`. See `002c` Section 6.5.7 for test specifications. |
